    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0F172A] px-4">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-emerald-600/20 rounded-full blur-[120px]" />
            </div>
            ...
            >
                <div className="text-center mb-8">
                    <div className="inline-flex p-3 bg-indigo-600 rounded-xl shadow-lg shadow-indigo-500/30 mb-4">
                        <Sprout className="text-white" size={32} />
                    </div>
                    <h2 className="text-3xl font-bold text-white mb-2">Welcome Back</h2>
                    <p className="text-slate-400">Continue your growth journey today.</p>
                </div>
